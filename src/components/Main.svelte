...
<main class="flex flex-col flex-1 p-4">
    ...
    >
        ...
        >
            ...
            <a class="blueShadow mx-auto lg:mr-auto text-base sm:text-lg md:text-xl montserrat relative overflow-hidden px-6 py-3 group rounded-full bg-white text-slate-950 cursor-pointer">
